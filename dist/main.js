...
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
var Swipe, easeOutHorizontalSlide, easeOutVerticalSlide, easing, gestureLock, get, getParent, horizontalSlide, lastTouchEvent, scrollInterval, slideHistory, swipe, taps, timeoutId, touchEvents, trx, verticalSlide, _;
...
slideHistory.filter(function(events) {
  return events.length > 1;
});

horizontalSlide = slideHistory.filter(function(e) {
  return gestureLock && gestureLock.type === 'horizontalSlide';
});

verticalSlide = slideHistory.filter(function(e) {
  return gestureLock && gestureLock.type === 'verticalSlide';
});

taps = touchEvents.filter(function(e) {
  return gestureLock && gestureLock.type === 'tap';
}).filter('type', 'touchend');
...
taps.filter({
  ...
  return console.log('button tapped');
});

easeOutVerticalSlide = verticalSlide.filter(function(events) {
  var $target, distance;
...
easeOutHorizontalSlide = horizontalSlide.filter(function(events) {
  var $target, distance;
  if (get(events, -1).type === 'touchmove') {
...
easeOutVerticalSlide.subscribe(function(events) {
  ...
  return scrollInterval = setInterval(function() {
    ...
    return el.scrollTop += dist / 5;
  }, 30);
});

easeOutHorizontalSlide.subscribe(function(e) {
  return swipe.letGo();
});
...
},{"./swipe.coffee":8,"C:\\projects\\turo-touch\\node_modules\\browserify\\node_modules\\insert-module-globals\\node_modules\\process\\browser.js":4,"buffer":1,"lodash":5,"tiny-rx":6}],8:[function(require,module,exports){
(function (process,global,Buffer,__argument0,__argument1,__argument2,__argument3,__filename,__dirname){
var Swiper, trx,
  __bind = function(fn, me){ return function(){ return fn.apply(me, arguments); }; };
...
module.exports = Swiper = (function() {
  function Swiper(containerSelector, wrapSelector, itemSelector, defaultSpeed) {
    var i, self, slide, sliderDimensions, _i, _j, _len, _len1, _ref, _ref1;
    ...
    this.slideWrap = document.querySelector(wrapSelector);
    this.slides = [];
    ...
    sliderDimensions = this.slider.getBoundingClientRect();
    this.slideWidth = sliderDimensions.width;
    this.slideWrap.style.width = (this.slides.length * this.slideWidth) + 'px';
    _ref1 = this.slides;
    ...
    trx.fromDomEvent('webkitTransitionEnd', this.slider).subscribe(function(e) {
...
},{"C:\\projects\\turo-touch\\node_modules\\browserify\\node_modules\\insert-module-globals\\node_modules\\process\\browser.js":4,"buffer":1,"tiny-rx":6}]},{},[7])